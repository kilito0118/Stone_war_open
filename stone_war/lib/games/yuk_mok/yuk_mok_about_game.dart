...
export 'package:stone_war/games/check/game_yuk_mok.dart';
export 'package:stone_war/games/game_components/about_game.dart';
export 'package:stone_war/games/game_components/about_multi.dart';
export 'package:stone_war/games/game_components/players_profile.dart';

class YukBoardPainter extends CustomPainter {
  final List<List<int>> board;

  YukBoardPainter(this.board);
